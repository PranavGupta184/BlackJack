...
while choice=="y":
    flag1 = 0
    lives=6
    listnumber=random.randint(1,3)
    wordsnumber=random.randint(0,900)
    if listnumber==1:
        word=words1[wordsnumber]
    elif listnumber==2:
        word=words2[wordsnumber]
    elif listnumber==3:
        word=words3[wordsnumber]
    dummyword=""
    p=len(word)
    for o in range(p):
        dummyword="_"+dummyword
    wordlist = []
    dummywordlist = []

    for i in range(len(word)):
        wordlist.append(word[i])
        dummywordlist.append(dummyword[i])

    #print(wordlist)
    #print(dummywordlist)
    print(logo)
    print("Guess The Word!!")
    for q in range(len(dummyword)):
        print(dummyword[q], end=" ")
    print()
    choice3 = '!'
    while lives>0:
        if choice3 == 'n' or flag1 == 2:
            break
        choice2='y'
        while choice2=='y':
            flag=0
            ...
            if leng>1 or leng==0:
                ...
                choice2=input("Do you wish to continue (Y to continue/ N to exit) - ")
                ...
                for m in range(len(dummywordlist)):
                    print(dummywordlist[m], end=" ")
                print()
                if flag==0:
    ...
    ________________|____
    ''')
        choice=input("Do you wish to continue (Y to continue / N to exit) - ")
        choice=choice.lower()
    if flag==2:
        choice3 = '!'
        choice=input("Do you wish to continue (Y to continue / N to exit) - ")
